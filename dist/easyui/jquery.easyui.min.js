...
$.ajax({type:opts.method,url:opts.url,data:_1d1,dataType:"json",headers:{Authorization: 'Bearer ' + localStorage.getItem('token')},success:function(data){
_1d2(data);
},error:function(){
 ...
 * rows --> size
 */
$.extend(_87b,{page:opts.pageNumber||1,size:opts.pageSize});
}
...
$.ajax({type:opts.method,url:opts.url,data:_925,dataType:"json",headers:{Authorization: 'Bearer ' + localStorage.getItem('token')},success:function(data){
_926(data);
},error:function(){
...
$.ajax({type:opts.method,url:opts.url,data:_aa9,dataType:"json",headers:{Authorization: 'Bearer ' + localStorage.getItem('token')},success:function(data){
_aaa(data);
},error:function(){
